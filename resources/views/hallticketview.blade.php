...
<!--                <h4 id="heading">Complete Your Profile</h4>
              ...
              <div class="card-header">
                  ...
                  <marquee   behavior="alternate" direction="left"><p style="font-size: 18px;"><b>Congratulations {{$key->pgapp_name}}  You are included in Allotment.Download Interview Memo</b></p></marquee>
<div class="box-body table-responsive">
         <table id="example1" class="table table-bordered table-striped table-responsive">
             <thead>
            <th width="2%"><font >Rank</font></th>
          <th width="2%"><font >Allotment Centre</font></th>
          <th width="2%"><font >Allotment Category</font></th>
         
              </thead>
         

            <tr>
       @foreach($allotstatusres as $ckey)     
        ...
        @endforeach    
                    ...
                    @else
                     <div class="card-header">
                           ...
                           <marquee   behavior="alternate" direction="left"><p style="font-size: 17px;"><b>Better Luck Next Time {{$key->pgapp_name}}  You are  not included in  allotment !!!</b></p></marquee>
...
<!--
                                                        <div class="col-sm-3">
                         <form action="{{route('changeoption')}}" method="get" name="pdffrom1">
                        <input type="hidden" name="merchanttxnid" id="merchanttxnid" value="{{$key->merchanttxnid}}">
                        <input type="hidden" name="tdate" id="tdate" value="{{$key->tdate}}">

                        <button type="submit" name="pdffrom1" class="btn btn-success">Click here to add New Options</button>
                    </form> 
                    </div>-->
 ...
 @endif
      ...
      <form action="{{route('loadview')}}" method="get" >
                     
     <button type="submit"  class="btn btn-primary">Upload Non creamy layer certificate for OBC/caste certificate SC/ST/OEC</button>
      </form>  
