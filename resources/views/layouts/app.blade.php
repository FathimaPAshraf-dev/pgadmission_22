...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container" style="text-align: center;">
          ...
          <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="badge badge-secondary">SSUS Admission Portal</span></h2>
...
<!--      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
   ...
   <nav class="navbar navbar-expand-md navbar-dark top bg-cyan"><div class="container" style="text-align: left;">
        ...
        <a href="https://ssus.ac.in/files/300/PG-ADMISSION-2025/3089/PG-ADMISSION-2025-26-NOTIFICATION.pdf" class="btn btn-dark  ">Notification</a>
        <a href="https://ssus.ac.in/files/300/PG-ADMISSION-2025/3088/PG-ADMISSION-2025-26-PROSPECTUS.pdf" class="btn btn-dark  ">Prospectus</a>
        <a href="register" class="btn btn-dark  ">Apply Now</a>
<!--        <a href="#" class="btn btn-dark  ">Programmes</a>
        <a href="#" class="btn btn-dark  ">Facilities</a>
        -->
