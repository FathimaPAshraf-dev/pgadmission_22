...
<!--                        <li id="confirm"><strong>Finish</strong></li>-->
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            </div> @include('reoptcampus') 
                        </div> <label for="btn_campus_ref"  name="btn_campus" id="btn_campus" class="next action-button">Save & Next</label>
                        <input hidden="true" type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                  ...
                  <label for="btn_payment" name="btn_payment" id="btn_payment" class="next action-button" >Submit</label> </div>
                  @endif
                         <input type="button" name="previous" form="pgpayment" class="previous action-button-previous" value="Previous" />

                      <input type="button" class="previous action-button-previous" value="Back to Home Page"
