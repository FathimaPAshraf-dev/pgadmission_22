  ...
  $("form[name='formpgapp']").validate({
    ...
    rules: {
       ...
       email: {
        ...
        postpgapp_aadharno1: {
            equalTo: '[name="postpgapp_aadharno"]',
            required: true,
        },
...
function pmode_pgm()
{
  ...
  var adsc_sl= document.getElementById('pgapp_adsc_sl').value;
  ...
  // alert(pgapp_cstream);
        ...
        type: 'POST',
        url: '/foroptionpmode',
        data:{"_token": "{{ csrf_token() }}","formData":adsc_sl},
        success: function (response) {
           
        $("#divsub1").html(response);
           ...
           <form class="form-horizontal" name="formpgapp" id="formpgapp" method="post" action="{{route('register')}}">
            ...
            <div class="offset-md-2">   
              ...
              <div class="card-body">
                 ...
                 <select  id="pgapp_adsc_sl" name="pgapp_adsc_sl"  class="form-control form-control-sm select2  {{ $errors->has('pgapp_adsc_sl') ? 'is-invalid' : '' }} target"  >
