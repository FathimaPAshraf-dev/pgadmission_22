 ...
 <div class="card card-info card-outline">
       <div class="form-horizontal">
            ...
            <div class="card-header with-border" style="text-align: center;">
                <h4>PG ADMISSION PART I REGISTRATION FORM <br></h4>
            </div>
<!--             <div class="card-header with-border" style="text-align: center;">
            ...
            <div class="offset-md-2">   
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5">
                      <input type="text" class="form-control form-control-sm {{ $errors->has('sslc_regno') ? 'is-invalid' : '' }}"  value="{{ old('sslc_regno') }}" id="sslc_regno" name="sslc_regno" placeholder="Enter your sslc register no">
