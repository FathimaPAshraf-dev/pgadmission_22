...
@php
  ...
  $lastdate=date('2024/04/08');
  $crndate = date('Y/m/d H:i:s'); 
  if($crndate < $lastdate) $t="hellooooo"; else $t="Thalaaa";
 ...
 <div class="card card-info card-outline">
       <div class="form-horizontal">
            ...
            <div class="card-header with-border" style="text-align: center;">
                ...
                <h5>SCOL ADMISSION PROGRAMMES-2024 Part I <br></h5>
            </div>
<!--             <div class="card-header with-border" style="text-align: center;">
            ...
            <form class="form-horizontal" name="formpgapp" id="formpgapp"  method="post" action="{{route('scolregisterpart1')}}">
               {{csrf_field()}}
              ...
              <div class="card-body">
                  ...
                  <div class="col-sm-5">
                     ...
                     <select  id="pgapp_stream_id" name="pgapp_stream_id"  class="form-control form-control-sm select2 {{ $errors->has('pgapp_stream_id') ? 'is-invalid' : '' }}" onchange="forsub()" >
                        ...
                        @foreach($scol_courses as $key)

            <option value="{{$key->course_id}}" > {{$key->course_code}}</option>
...
<!--                          <option value='13'>P.G Diploma (Project mode)</option>-->
                ...
                <div class="form-group row"> 
                  <label class="col-sm-4 control-label">Name as in SSLC certificate<font color="red">*</font></label>
              ...
              <div class="card-footer">
                    <p style="font-size: 16px">Please ensure that all entries / information provided are correct. You are not allowed to edit the data, once you submit the part 1 registration form. /
