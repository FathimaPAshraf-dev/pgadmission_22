        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="card card-info card-outline"> 
              ...
              <div class="card-body">
                  <h4 style="color: #6b174e"><b>SCOL ADMISSION 2024 </b>   
                 ...
                 <span class="blink_text "><b>Please read the instructions and notification carefully before going to apply / അപേക്ഷിക്കുന്നതിന് മുമ്പ് നിർദ്ദേശങ്ങൾ ശ്രദ്ധാപൂർവ്വം വായിക്കുക </b></span>  
                  <button type="button" class="btn btn-flat btn-xs btn-info" data-toggle="modal" data-target="#tallModal111">
...
" target="_blank" class="btn btn-flat btn-xs btn-info">
                        ADMISSION TO THE M.A. ,M.Sc, M.S.W, MFA ,MPES, DUAL MAIN MASTERS
IN DISASTER MANAGEMENTAND P.G.DIPLOMA PROGRAMMES- 2024
NOTIFICATION  <i class="fa fa-info-circle"></i></a>          -->

                 <a href="https://ssus.ac.in/files/284/Scol/2482/SCOL---SANSKRIT.pdf" target="_blank" class="btn btn-flat btn-xs btn-danger">
                        Basic Sanskrit Course in Malayalam - Notification  <i class="fa fa-info-circle"></i></a> <br><br>
                <a href="https://ssus.ac.in/files/284/Scol/2483/SCOL-AYURVEDA.pdf" target="_blank" class="btn btn-flat btn-xs btn-danger">
                       Sanskrit for Special Purpose - Ayurveda - Notification  <i class="fa fa-info-circle"></i></a>
                        <br><br><br><br>
