...
<!--    <pageheader name="MyHeader1" content-right=""
   ...
   -->
    ...
    <p style="text-align: center; font-size: 14px;">
       <u><b>Final Grade Report(Provisional)</b></u> 
    </p>
   ...
   <table border="1" style="border:1px; border-collapse:collapse;" align="center">
      ...
      <p style="font-size: 11px;">You have not Secured semester Grade point average in all Semesters</p>
        
         @else
           @foreach($cgpa as $key)
            <th style="text-align: center" colspan="2">FINAL GRADE POINT AVERAGE</th>
