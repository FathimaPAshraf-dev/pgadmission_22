...
<!--        <p style="text-align: center;  font-family: arial, sans-serif;font-weight:bold;font-size: 17px;">
                 ...
                 @if($adsc_admnyear==2021 || $adsc_admnyear==2020)
   ...
   @endif
      ...
      <p style="font-size: 12px; text-align: left"><b>Note 1: Claim for admission shall be subject to the satisfactory verification of qualification and eligibility</b></p> 
