    ...
    <center><p style="font-size: 13px;">Kalady Post,Ernakulam(Dist)&nbsp;&nbsp;Kerala-683574&nbsp;&nbsp;Fax:0484-2463380<br>
            Tel:0484-2463380&nbsp;&nbsp;email:reg@ssus.ac.in</p></center>
                 ...
                 <p style="text-align: center;  font-family: arial, sans-serif;font-weight:bold;font-size: 14px;">
                    @if(Auth::user()->ent_hallticket_stat==2)
                     <u><b>PG ENTRANCE EXAMINATION SC/ST RE-NOTIFICATION HALL TICKET 2024-25 (PROVISIONAL)</u>
                    @elseif(Auth::user()->ent_hallticket_stat==3)
                     <u><b>PG ENTRANCE EXAMINATION RE-NOTIFICATION HALL TICKET 2023-24 (PROVISIONAL)</u> 
                    @else
                    <u><b>PG ENTRANCE EXAMINATION HALL TICKET 2025-26 (PROVISIONAL)</u>
                    @endif
...
<!--                 <p style="text-align: center;  font-family: arial, sans-serif;font-weight:bold;font-size: 12px;">( To be returned to the Invigilator after exam)</p>-->
    ...
    <div class="card-body table-responsive" >
        ...
        <table border="1" class="table table-striped">
            ...
            <td>Date & Time </td>
            @if(Auth::user()->ent_hallticket_stat==2)
            <td colspan="2"><b>14/07/2023 11 AM to 1 PM </b> </td>
            @elseif(Auth::user()->ent_hallticket_stat==3)
            <td colspan="2"><b>20/07/2023 2 PM to 4 PM </b> </td>
            @else
            ...
            <td><img  src="{{public_path('images/pgphoto/'.Auth::user()->pgapp_photo)}}" width="120" height="150" alt="user"> </td>
             ...
             @if(Auth::user()->pgapp_adsc_sl==1115 || Auth::user()->pgapp_adsc_sl==1112 || Auth::user()->pgapp_adsc_sl==1113 || Auth::user()->pgapp_adsc_sl==1114)
             ...
             <tr>
              ...
              @elseif(Auth::user()->pgapp_adsc_sl==1130)
             <tr>
                 <td  style="font-size: 13px;font-weight:bold;" colspan="3">* Aptitude / Practical /Portfolio presentation / interview for MFA/ Theatre / Music / Dance (Bharathanatyam & Mohiniyattom) will be conducted on the same day itself at Main Centre, Kalady. The time slot of each candidate attending the Aptitude / Practical /Portfolio presentation will be informed by the Head of the Departments concerned.</td>    
             </tr>
             ...
             <tr>
              ...
              @elseif(Auth::user()->pgapp_adsc_sl==1131)
             <tr>
...
9.  Candidates shall not write their names or identification marks inside the answer book, doing so will be a<br>
...
11. Admit Cards are issued to all candidates, whoever applied provisionally, subject to subsequent verification of<br>
eligibility.<br><br>
...
<!--16. The Candidates shall wear a mask throughout and shall strictly adhere to COVID 19 protocol issued by the Government of Kerala.-->
 ...
 <p style="text-align: center;">***</p>
  ...
  @if(Auth::user()->pgapp_adsc_sl==1053)

  <p style="font-size: 17px; text-align: center;"><b><u>MSW Entrance Examinations 2024- Special Instructions to Candidates </u></b></p>   
