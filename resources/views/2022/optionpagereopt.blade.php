...
//      alert("yyyyy");
      $.ajax({
        type: 'POST',
        url: '/store_options',
        data:{ "center_sl1":center_sl1,"center_sl2":center_sl2,"center_sl3":center_sl3},
...
if ($.trim($('#center_sl1').val()) == "") {
  ...
  if ($.trim($('#center_sl3').val()) == "") {
    error_center_sl1 = 'Select your III rd Centre Choice ';
    alert("select your III rd Centre Choice");
 ...
 <div class="card card-info card-outline">
       <div class="form-horizontal">
                        ...
                        <select class="form-control form-control-sm select2 col-md-8 {{ $errors->has('center_sl1') ? 'is-invalid' : '' }}"  id="center_sl1" name="center_sl1" required=""
                            ...
                            <option value="" selected disabled >
                              ...
                              @foreach($centre_options as $cent)
                                <option value="{{$cent->sh_reopt_cent }}"   >
        ...
        <div class="row">
          ...
          <p style="text-align: left;  font-family: arial, sans-serif; color: black; font-size: 13px;"><b>The Transfer of Centre will be based on the position of the candidate in the ranklist, availability of seats (should be within the sanctioned strength 
