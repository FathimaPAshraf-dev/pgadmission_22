  ...
  <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
           ...
           <li style="font-size: 13px; color: red">
...
<div class="row">
   ...
   <div class="col-lg-6">
   <label>Are you claiming caste reservation?</label><br>

<input type="radio" name="caste_reservation" value="1" id="caste_yes" 
    {{ $key->reservation_claim_status === 1 ? 'checked' : '' }}>
<label for="caste_yes">Yes</label>

<input type="radio" name="caste_reservation" value="0" id="caste_no" 
    {{ $key->reservation_claim_status === 0 ? 'checked' : '' }}>
<label for="caste_no">No</label>
...
<div class="row">
        ...
        <input type="number" name="pgapp_pincode" id="pgapp_pincode" placeholder="Enter pin code" value="{{$key->pgapp_pincode}}"  required="" class="form-control form-control-sm col-md-8"/> 
        <span id="error_address2" class="text-danger"></span>    
        </div>
         </div>    
    </div>
