...
class TransactionRequest
{
    ...
    // private $reqHashKey = "e0a176300774097599";
    private $reqHashKey = "";
    ...
    private function writeLog100($data){
    ...
    {
        $fileName = "date_" . date("Y-m-d") . ".txt";
        $filePath = storage_path("logs/" . $fileName); // Logical path    
        $data = date("Y-m-d H:i:s") . " - " . $data . PHP_EOL; // Add newline for readability    
        file_put_contents($filePath, $data, FILE_APPEND); // Append data to file
    }
